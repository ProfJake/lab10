NOTE:  The node modules for this project were installed on Ubuntu/Linux 
version 16.04.  Users of other systems (Windows, macOS, etc) may need to 
...
express-session (available via npm) - Middleware for simple sessions
body-parser (available via npm) - Middleware for parsing incoming POST data
